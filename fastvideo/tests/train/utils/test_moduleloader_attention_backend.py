...
from fastvideo.attention.selector import active_attention_backend_scope
...
def test_load_transformer_scopes_attention_backend(monkeypatch, tmp_path) -> None:
    ...
    def _fake_load_module(**kwargs):
        del kwargs
        scope = active_attention_backend_scope()
    ...
    assert active_attention_backend_scope() is None
